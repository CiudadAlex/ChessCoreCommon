...
/**
 * GeneradorMovimientosPosiblesAlfil.
 *
 * @author Alejandro
 */
public class GeneradorMovimientosPosiblesAlfil extends AbstractGeneradorMovimientosPosibles {
    ...
    public void generaMovimientosPosiblesSinRestriccionesYAddToMovimientosPosiblesSinRestricciones(final PosicionTablero posicionTablero,
        ...
        final List<Direccion> listaDirecciones = RepositorioDirecciones.getDiagonales();
    ...
    public void generaMovimientosPosiblesYAddToLista(final PosicionTablero posicionTablero, final Tablero tablero,
        ...
        generaMovimientosPosiblesEnDireccionesDadasYAddToLista(posicionTablero, tablero, RepositorioDirecciones.getDiagonales(),
                listaMovimientos);
    }
